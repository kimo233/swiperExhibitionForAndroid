...
export default {
  ...
  methods: {
    next() {
      this.step = 2
      console.log(this.sizeForm.planname, this.stratrgy, this.value.toString(), this.value.toString(), this.plansync, this.sizeForm.planauth)
    },
    forw() {
      this.step = 1
    },
    ...
    commit() {
      planAdd(this.sizeForm.planname, this.stratrgy, this.value.toString(), this.value.toString(), this.plansync, this.sizeForm.plancontent.toString(), this.auth).then(response => {
