...
export default {
  ...
  methods: {
    ...
    submit() {
      materialAdd(this.sizeForm.name, this.sizeForm.imgStr, this.userid).then(response => {
        console.log(response);

      })
    },
    pr() {
      console.log(this.sizeForm.name, this.sizeForm.imgStr, this.userid)
    }
  }
}
</script>
